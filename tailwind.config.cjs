    ...
    extend: {
      ...
      keyframes: {
        leftBlobPulse: {
          ...
          "30%":{
            "border-radius": "40% 60% 62% 38% / 65% 54% 46% 35% "
          },
          "65%":{
            "border-radius": "50% 50% 58% 42% / 33% 42% 58% 66% "
          },
          "100%":{
            "border-radius": "33% 67% 45% 55% / 43% 50% 50% 57% "
          },
        ...
        rightBlobTransform: {
          ...
          "40%":{
            transform: "translate(-17%, 5%) scale(1)"
          },
          "60%":{
        ...
        middleBlobTransform: {
          ...
          "18%":{
            transform: "translate(-1%, -19%) scale(0.95)"
          },
          "35%":{
          ...
          "66%":{
            transform: "translate(-9%, 19%) scale(1.25)"
          },
          "84%":{
            transform: "translate(2%, 16%) scale(1.1)"
          },
          "100%":{
            transform: "translate(0%, 0%) scale(1)"
          },
